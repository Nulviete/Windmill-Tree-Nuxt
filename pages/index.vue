<template>
    <div class="-mt-40">
        ...
        <div class="hero-block">
            ...
            <h3> …the worst is not that everything might <span class="hero-text-hl">change  
                </span><br>
                but that everything remains the <span class="hero-text-hl">same!</span><br>
                <span class="kostenko">-Lina Kostenko </span><span class="kostenko-des" style="font-size: 20px; font-weight: normal;">(a Ukrainian poet, journalist, writer, publisher, and former Soviet dissident)</span> 
            </h3>
        </div>
        ...
        <div class="foundation-sec">
            ...
            <div class="Foundation-description-mid" style="">
                LATEST NEWS
            </div>
            <div class="socials">
            ...
            <!-- Our mission section -->
             <div class="our-mission-block">
                <div class="our-mission-left" style="position: relative;">
                    ...
                    <p class="pc-ver">
                        Located in the breathtaking Izery Mountains region, our diverse team is a bland of individuals from Poland, Ukraine, Germany and Czech Republic.
                    </p>
                </div>
                <div class="our-mission-right">
                    <h1 style="">Our mission</h1>
                    <img class="mob-ver" src="~/assets/our-mission/our-mission-1-mob-x.png" alt="" srcset="">
                    <div class="om-first" style="">
                        We focus on building a more inclusive and sustainable world by delivering innovative high quality non-formal education, supporting marginalized and refugee youth, and enhancing the quality of youth work, international exchange and volunteering programs.
                    </div>
                    <div class="mob-ver om-second">
                        Located in the breathtaking Izery Mountains region, our diverse team is a bland of individuals from Poland, Ukraine, Germany and Czech Republic.
                    </div>
                    <img class="pc-ver" src="~/assets/our-mission/our-mission-2.png" alt="" srcset="">
                    <div class="pc-ver" style="font-size: 14px; text-align: left;">
                        *all the photos you see are from activities and projects we have organised
                    </div>
                </div>
             ...
             <div class="our-activities-block flex flex-row pc-ver">
                <div class="our-activities-left">
                    ...
                    <div class="our-activities-pictures">
                        <img class="img-up" src="~/assets/our-activities/our-activities-img-up.png" alt="" srcset="">
                        <img class="img-mid-l" src="~/assets/our-activities/our-activities-img-mid-l.png" alt="" srcset="">
                        <img class="img-mid-r" src="~/assets/our-activities/our-activities-img-mid-r.png" alt="" srcset="">
                        <img class="img-bot-l" src="~/assets/our-activities/our-activities-img-bot-l.png" alt="" srcset="">
                        <img class="img-bot-r" src="~/assets/our-activities/our-activities-img-bot-r.png" alt="" srcset="">
                    </div>
                ...
                <div class="our-activities-right ">
                    ...
                    <ul>
                        <li>Art, eco and social initiatives of youth in Jelenia Góra and region (Solidarity projects, happenings, charity actions ) Inclusive, mixed-ability mountain trips</li>
                    </ul>
                    
                    <div class="our-activities-r-title">International projects</div>
                    <ul>
                        <li>Accreditation in Erasmus+ Youth Sector</li>
                        <li>Around 100 participants from Europe, Africa, South America annually;</li>
                        <li>Trainings and Youth exchanges; Topics: Non-formal education, Youth work,</li>
                        <li>Mental health, Nature, Inclusion, Creative art forms</li>
                    </ul>
                    
                    <div class="our-activities-r-title">Educational and Mental health support for Ukrainian refugee children and youth</div>
                    <ul>
                        <li>Outdoor activities, including mountain trips, summer camps, and art therapy sessions.</li>
                        <li>Regular programs for children living in collective housing centers in rural areas (around 100 children)</li>
                    </ul>
                    
                    <div class="our-activities-r-title">International volunteering program</div>
                    <ul>
                        <li>European Solidarity Corps Program </li>
                        <li>Hosting and coordinating international volunteers in the Sudety region (local sport clubs, schools, culture centers in rural areas)</li>
                    </ul>
                </div>
             ...
             <div class="our-activities-mob mob-ver">
                ...
                <div class="our-activities-subtitle our-activities-subtitle-1">Local activities & initiatives</div>
                <ul>
                    <li>Art, eco and social initiatives of youth in Jelenia Góra and region (Solidarity projects, happenings, charity actions ); </li>
                    <li>Inclusive, mixed-ability mountain trips</li>
                </ul>
                <div class="our-activities-subtitle our-activities-subtitle-2">Educational and Mental health support for Ukrainian refugee children and youth</div>
                <ul>
                    <li>Regular programs for children living in collective housing centers in rural areas (around 100 children) </li>
                    <li>Outdoor activities, including mountain trips, summer camps, and art therapy sessions.</li>
                </ul>
                <div class="our-activities-subtitle our-activities-subtitle-3">International projects</div>
                <ul>
                    <li>Accreditation in Erasmus+ Youth Sector Around 100 participants from Europe, Africa, South America annually; </li>
                    <li>Trainings and Youth exchanges; Topics: Non-formal education, Youth work, Mental health, Nature, Inclusion, Creative art forms</li>
                </ul>
                <div class="our-activities-subtitle our-activities-subtitle-4">International volunteering program</div>
                <ul>
                    <li>European Solidarity Corps Program </li>
                    <li>Hosting and coordinating international volunteers in the Sudety region (local sport clubs, schools, culture centers in rural areas)</li>
                </ul>
             ...
             <div class="numbers-images pc-ver">
                ...
                <div class="numbers-image">
                    ...
                    <div class="number-text">Participants from all around the world took part in our projects</div>
                </div>
                ...
                <div class="numbers-image">
                    ...
                    <div class="number">20+</div>
                    <div class="number-text" style="height: 70px;">International partners</div>
                </div>
